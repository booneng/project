...
all: multicore test simpledag simpledagx task_AB masterslave_mailbox multicoregetdata ncpundfe multicore_logimp_thr1 multicoreSimple ncpundfeX CPUorDFEbest best_partition
